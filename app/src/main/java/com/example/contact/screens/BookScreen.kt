...
import com.example.contact.domain.model.ContactModel
import com.example.contact.domain.model.TagModel
import com.example.contact.routing.Screen
import com.example.contact.ui.components.AppDrawer
import com.example.contact.ui.components.Contact
...
private fun ContactsListPreview() {
    ContactsList(
        ...
        contacts = listOf(
            ContactModel(1, "Helen", "Chawder", "911"),
            ContactModel(2, "Helen", "Chawder", "911"),
            ContactModel(3, "Helen", "Chawder", "911")
        ),
        onContactClick = {}
    )
}